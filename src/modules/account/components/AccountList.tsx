...
export const AccountList: React.FC<IAccountListProps> = ({ accounts }: IAccountListProps) => {
  ...
  const columns: ColumnProps<IAccount>[] = [
    ...
    },
    {
      ...
      render: function emailEnabled(value, record) {
        return <Switch checked={record.email_validation_enabled} disabled />;
      },
    },
    {
      key: 'redirect_domain',
    ...
    },
    {
      ...
      title: 'Logo',
      dataIndex: 'logo',
      render: function logo(_text) {
        return <img src={_text} style={logoStyle} />;
      },
    },
    {
      key: 'signature',
